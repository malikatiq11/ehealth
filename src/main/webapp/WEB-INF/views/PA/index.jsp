...
<script type="text/javascript"  src="http://ajax.googleapis.com/ajax/libs/angularjs/1.4.8/angular-route.js"></script>
	...
	<script type="text/javascript" src="/eHealthService/resources/js/controller/PAController.js"></script>
	...
	<div class="wrapper">
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu"><a ng-style="changevisibilty" href="#" > Welcome {{PAName}}</a>
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#/GetRequest"> <span>Get Request</span>
			</a></li>
			...
			<li class="treeview"><a href="#/AddAppointment"> <span>Add Appointment</span>
			</a></li>
		</ul>
