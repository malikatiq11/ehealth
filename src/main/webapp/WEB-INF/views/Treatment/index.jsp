...
<script type="text/javascript" src="https://cdn.jsdelivr.net/ngstorage/0.3.6/ngStorage.min.js"></script>
	...
	<script type="text/javascript" src="/eHealthService/resources/js/pooling/angular-sanitize.js"></script>

 
 for web notfication
 <script src="https://rawgit.com/sagiegurari/HTML5-Desktop-Notifications/master/desktop-notify.js"></script>
...
<!-- angular controller -->
<script type="text/javascript" src="/eHealthService/resources/js/controller/TreatmentController.js"></script>
	
<!-- use for pooling in sync with DB(Spring controller) -->
...
<script type="text/javascript" src="/eHealthService/resources/js/notification/desktop-notify.js"></script>
<script type="text/javascript" src="/eHealthService/resources/js/notification/angular-web-notification.js"></script>
	...
	<div class="wrapper">
		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
					<li class="dropdown user user-menu"><a ng-style="changevisibilty" href="#" > Welcome {{DoctorName}}</a>
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#/PatientRequest"> <span>Waiting List</span>
			<li class="treeview"><a href="#/GetVisit"> <span>Search History</span>
			</a></li>
				<li class="treeview"><a href="#/LaboratoryObservation"> <span>Previous Labs Result</span>
			</a></li>
			<li class="treeview"><a href="#/PreviousVisit"> <span>PreviousVisit</span>
			</a></li>
